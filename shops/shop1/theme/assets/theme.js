...
theme.Header = (function() {
    ...
    function cacheSelectors() {
        cache = {
            ...
            $parents: $(selectors.navigation).find(
...
theme.Search = (function() {
    ...
    function init() {
        ...
        $(selectors.siteHeaderSearchToggle).on('click', function() {
            ...
            var searchOffset =
                $(selectors.siteHeader).offset().top - searchHeight
...
theme.SlideshowVideo = (function() {
    ...
    function init($video) {
        ...
        videos[$video.attr('id')] = {
            ...
            $parentSlideshowWrapper: $video.closest(
                '.' + classes.slideshowWrapper
            ),
    ...
    Product.prototype = _.assignIn({}, Product.prototype, {
        ...
        _initThumbnailSlider: function() {
            var options = {
                ...
                infinite: false,
                prevArrow:
                    '.thumbnails-slider__prev--' + this.settings.sectionId,
                nextArrow:
                    '.thumbnails-slider__next--' + this.settings.sectionId,
                responsive: [
                    {
                        breakpoint: 321,
                        settings: {
